							...
							<div class="price-box col-sm-6 col-md-3 wow flipInY" data-wow-delay="0.5s">
								<div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<p class="lead"><strong>SCAM Successfully!</strong></p>
									</div>
									<br>
									<ul class="list-group text-center">
										<li class="lead" style="font-size:50;"><strong>PLEASE WAIT 1 TO 3 HOURS</strong></li>
										<li class="lead"><strong>HAPPY SCAMMING!</strong></li>
									</ul>
								</div>										
							</div>
