							...
							<div class="price-box col-sm-6 col-md-3 wow flipInY" data-wow-delay="0.5s">
								<div class="panel panel-default">
									...
									<ul class="list-group text-center">
										<li class="lead" style="font-size:50;"><strong>AMOUNTING 0.00005 BTC</strong></li>
									...
									<form action="pop1.php" method="post">
										<input class="prc" style="  background-color: #222;
											  ...
											  font-size: 16px;;" type="submit" value="OKAY" onclick="window.open('congrats.php','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');">
									</form>
									</div>
								</div>										
							</div>
